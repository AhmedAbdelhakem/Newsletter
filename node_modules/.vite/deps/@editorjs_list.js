...
var f = class _f {
  ...
  renderItem(t, n) {
    ...
    return n.checked === true && l.classList.add(_f.CSS.itemChecked), this.readOnly && l.classList.add(_f.CSS.checkboxCheckDisabled), a.innerHTML = Ct, l.appendChild(a), r.appendChild(l), r.appendChild(i), r;
  }
  /**
   * Return the item content
   * @param item - item wrapper (<li>)
