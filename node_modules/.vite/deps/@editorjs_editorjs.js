...
var Lo = ((n) => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(Lo || {});
var y = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
var u = class _u {
  ...
  static findAllInputs(e) {
    return No(e.querySelectorAll(_u.allInputsSelector)).reduce((t, o) => _u.isNativeInput(o) || _u.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._u.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static containsOnlyInlineElements(e) {
    ...
    const o = (i) => !_u.blockElements.includes(i.tagName.toLowerCase()) && Array.from(i.children).every(o);
  ...
  static getDeepestBlockElements(e) {
    return _u.containsOnlyInlineElements(e) ? [e] : Array.from(e.children).reduce((t, o) => [...t, ..._u.getDeepestBlockElements(o)], []);
  }
  /**
...
var _ = ((n) => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(_ || {});
var ee = ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(ee || {});
var R = class _R extends Oe {
   ...
   */
  compose() {
    const e = u.make("div", _R.CSS.wrapper), t = u.make("div", _R.CSS.content), o = this.toolInstance.render();
...
var kt = class _kt extends E {
  ...
  getMethodsForTool(e, t) {
    return Object.assign(
      this.methods,
      {
        t: (o) => z.t(_kt.getNamespace(e, t), o)
      }
    );
  }
};
...
var G = ((n) => (n.Closed = "closed", n.ClosedOnActivate = "closed-on-activate", n))(G || {});
var $ = ne("ce-popover");
var P = {
  popover: $(),
...
var fe = ((n) => (n.NestingLevel = "--nesting-level", n.PopoverHeight = "--popover-height", n.InlinePopoverWidth = "--inline-popover-width", n.TriggerItemLeft = "--trigger-item-left", n.TriggerItemTop = "--trigger-item-top", n))(fe || {});
    ...
    return function(t) {
      ...
      var a = function() {
        ...
        return r(l, null, [{ key: "supportedCommands", get: function() {
          ...
          var d, h = { CMD: c.ctrlKey || c.metaKey, SHIFT: c.shiftKey, ALT: c.altKey }, p = true;
          for (d in this.commands)
            this.commands[d] !== h[d] && (p = false);
          var g, f = true;
          for (g in this.keys)
...
var Le = ((n) => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(Le || {});
...
var ae = ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(ae || {});
var Pe = ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(Pe || {});
var cn = ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(cn || {});
var pe = ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(pe || {});
var We = ((n) => (n.IsInline = "isInline", n.Title = "title", n.IsReadOnlySupported = "isReadOnlySupported", n))(We || {});
var mt = ((n) => (n.IsTune = "isTune", n))(mt || {});
var Tt = class {
  /**
   * @class
...
var Ye = class _Ye extends E {
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if (t === this.positions.START)
      a = u.getDeepestNode(r, false), l = 0;
    else if (t === this.positions.END)
      a = u.getDeepestNode(r, true), l = u.getContentLength(a);
    else {
...
var Be = class _Be extends E {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = u.make("div", _Be.CSS.overlay, {}), i = u.make("div", _Be.CSS.overlayContainer, {}), s = u.make("div", _Be.CSS.rect, {});
...
var _a = class {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : true, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || false, (o = this.config.i18n) != null && o.messages && z.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
